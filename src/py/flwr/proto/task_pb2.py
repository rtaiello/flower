...
_SECUREAGGREGATION_NAMEDVALUESENTRY = _SECUREAGGREGATION.nested_types_by_name[
    "NamedValuesEntry"
]
...
Value = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "Sint64List": _reflection.GeneratedProtocolMessageType(
            "Sint64List",
            (_message.Message,),
            {
...
SecureAggregation = _reflection.GeneratedProtocolMessageType(
    "SecureAggregation",
    (_message.Message,),
    {
        "NamedValuesEntry": _reflection.GeneratedProtocolMessageType(
            "NamedValuesEntry",
            (_message.Message,),
            {
