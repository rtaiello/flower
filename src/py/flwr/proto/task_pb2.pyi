...
class Value(google.protobuf.message.Message):
    ...
    class DoubleList(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing_extensions.Literal["vals", b"vals"]
        ) -> None: ...
...
class SecureAggregation(google.protobuf.message.Message):
    ...
    def named_values(
        ...
        typing.Text, global___Value
    ]: ...
    def __init__(
        self,
        *,
        named_values: typing.Optional[
            typing.Mapping[typing.Text, global___Value]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["named_values", b"named_values"]
    ) -> None: ...
