...
class _ReasonEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Reason.ValueType],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class ServerMessage(google.protobuf.message.Message):
    ...
    class ReconnectIns(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing_extensions.Literal["seconds", b"seconds"]
        ) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        get_properties_ins: typing.Optional[
            global___ServerMessage.GetPropertiesIns
        ] = ...,
        get_parameters_ins: typing.Optional[
            global___ServerMessage.GetParametersIns
        ] = ...,
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"fit_ins",
            "get_parameters_ins",
            b"get_parameters_ins",
            "get_properties_ins",
            b"get_properties_ins",
            "msg",
            b"msg",
            "reconnect_ins",
            b"reconnect_ins",
...
class ClientMessage(google.protobuf.message.Message):
    ...
    class GetPropertiesRes(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            ...
            properties: typing.Optional[
                typing.Mapping[typing.Text, global___Scalar]
            ] = ...,
        ) -> None: ...
        def HasField(
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                "properties", b"properties", "status", b"status"
            ],
        ) -> None: ...
    ...
    class GetParametersRes(google.protobuf.message.Message):
        ...
        def HasField(
            self,
            field_name: typing_extensions.Literal[
                "parameters", b"parameters", "status", b"status"
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
    ...
    def __init__(
        ...
        *,
        ...
        get_properties_res: typing.Optional[
            global___ClientMessage.GetPropertiesRes
        ] = ...,
        get_parameters_res: typing.Optional[
            global___ClientMessage.GetParametersRes
        ] = ...,
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"fit_res",
            "get_parameters_res",
            b"get_parameters_res",
            "get_properties_res",
            b"get_properties_res",
            "msg",
            b"msg",
        ],
    ) -> builtins.bool: ...
...
class Scalar(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["scalar", b"scalar"]
    ) -> typing.Optional[
        typing_extensions.Literal["double", "sint64", "bool", "string", "bytes"]
    ]: ...
